...
class UserTarget(models.Model):
    # user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_targets')
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='user_target')
