...
class ContactFilter(django_filters.FilterSet):
    ...
    from_date = django_filters.DateFilter(field_name='created_on', lookup_expr='date__gte', label='From Date')
    to_date = django_filters.DateFilter(field_name='created_on', lookup_expr='date__lte', label='To Date', required=False)
