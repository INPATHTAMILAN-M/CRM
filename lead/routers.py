...
from lead.viewsets.contact_assignment_viewset import ContactAssignmentViewSet
...
router.register(r'contact_assignment',ContactAssignmentViewSet , basename='contact_assignment')
